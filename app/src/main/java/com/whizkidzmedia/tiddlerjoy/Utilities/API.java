...
public class API {
    ...
    private static final String HOST_SERVER="http://52.33.186.21/api/";//"http://54.254.252.2/api/";
    ...
    public static final String CHILD_PROFILES_LISTINGS = SERVER_URL_CHILD+"listing/";
}
